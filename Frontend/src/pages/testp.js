...
export default function DashProfile() {
  ...
  return (
    ...
    <div className="col-span-12 lg:col-span-10  flex justify-center" style={{zIndex:1, position: 'relative'}}>
<div className="flex flex-col gap-0 w-6/12" style={{zIndex:1, position: 'relative'}}>
         <h1 className='my-7 text-center font-semibold text-3xl text-white'></h1>
     
        <form className='flex flex-col gap-4 relative ' style={{zIndex:1}}>
          <input
          type='file'
          accept='image/*'
